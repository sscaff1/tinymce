...
describe('phantom.tinymce.themes.silver.window.WindowManagerAlertTest', () => {
  ...
  it('Check the basic structure of the alert dialog', async () => {
    ...
    const sink = SelectorFind.descendant(SugarDocument.getDocument(), '.mce-silver-sink').getOrDie('Cannot find sink element');
